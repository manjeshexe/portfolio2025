...
const AnimateAura = () => {
  ...
  const backgroudColor = useMotionTemplate`
    radial-gradient(100% 145% at 50% 0%, #020617 60%, ${color})`;

  const mobilebackgroudColor = useMotionTemplate`
    radial-gradient(150% 140% at 50% 0%, #020617 60%, ${color})`;
  ...
  return (
    <motion.div
      style={{
        ...
        // ],
        backgroundImage:
          window.innerWidth < 600 ? mobilebackgroudColor : backgroudColor,
      }}
