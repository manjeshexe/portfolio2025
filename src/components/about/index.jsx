...
const About = () => {
  ...
  return (
    <div className={"w-full mx-auto h-full md:h-screen mt-20 md:mt-0"}>
      <div
        id="About"
      ...
      >
        <div className="flex flex-col items-start justify-center md:mt-20">
          ...
          >
            ...
            {inView && (
              <div
                className={`flex w-[200px] my-10 md:w-1/3 border rounded-2xl  ${
                  theme === "light"
              ...
              >
                <img
                  className={`-translate-x-2 -translate-y-2 bg-red-200 rounded-2xl border  hover:translate-y-0 hover:translate-x-0 transition-all brightness-50 hover:brightness-100 ${
